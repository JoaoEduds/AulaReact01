...
/*useEffect é um hook que permite gerenciar o ciclo de vida do componente quando ele é desenvolvido 
utilizando a sintaxe JSX

a sintaxe do useEffect
useEffect( function (){

    return function () <-- willUnmount
}, [] didMont //executa uma vez só)
   [lista de valores observados] didUpdate para cada valor que foi
*/
...
export default function DataV2(props){
    ...
    },[dataAtual]) //<-- O que observar para executar a função a cada atualização da data
